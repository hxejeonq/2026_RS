...
# ItemCF + UserCF + SVD Embedding + Meta Features
# LightGBM + RandomForest Ensemble
# ==========================================================
...
# ==========================================================
# 1. Load Base Model Predictions and Embeddings
# ==========================================================
print("1. 협업 필터링 결과 및 잠재요인 임베딩 로드")

cf_item_val = pd.read_csv('data/pred_item_cf_val.csv')
cf_user_val = pd.read_csv('data/pred_user_cf_val.csv')

cf_item_val = cf_item_val.rename(columns={
    'predicted_rating': 'feat_item_cf',
    'true_rating': 'actual_rating',
    'item_id': 'movie_id'
})

cf_user_val = cf_user_val.rename(columns={
...
# ==========================================================
# 3. Meta-Level Statistical Features
# ==========================================================
...
total_df = pd.merge(
    cf_item_val,
    cf_user_val[['user_id', 'movie_id', 'feat_user_cf']],
    on=['user_id', 'movie_id'],
    how='left'
)
...
# ROC-AUC (평점 4점 이상을 Positive로 정의)
...
# ==========================================================
# 8. Top-K Recommendation Evaluation
# ==========================================================
...
# ==========================================================
# 9. Final Meta Model Re-Training
# ==========================================================
...
# ==========================================================
# 10. Save Models and Meta Features
# ==========================================================
